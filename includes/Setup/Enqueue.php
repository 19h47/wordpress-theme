...
class Enqueue {
	...
	public function enqueue_scripts() : void {
		...
		$data = array(
			...
			'messages'               => array(
				'value_missing' => array(
					'default' => _x( 'Please fill out this field.', 'messages', 'wordpresstheme' ),
				),
				'type_mismatch' => array(
					'email'   => _x( 'Please enter an email address.', 'messages', 'wordpresstheme' ),
					'url'     => _x( 'Please enter a URL.', 'messages', 'wordpresstheme' ),
					'default' => _x( 'Please match the expected format.', 'messages', 'wordpresstheme' ),
				),
			),
		);
